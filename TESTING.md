...
to Friendly Digest's main readme file here: [README](https://github.com/WebSlinger88/Friendly-Digest/blob/master/README.md).
...
You can find a link to the Excel spreadsheet and downloadable PDF report here: [Friendly Digest Testing Docs](https://github.com/WebSlinger88/Friendly-Digest/tree/master/testing).
